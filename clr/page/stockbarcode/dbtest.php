...
if (!$existing_record) {
    ...
    $sql_insert = "INSERT INTO add_product (id_additem, name_product, category_product, code, barcode, date_time_in, date_time_out, status, boxnumber, operatorid)
                   VALUES (:id_additem, :name_product, :category_product, :code, :barcode, now(), now(), 1, 'ว่าง', :operatorid)";
...
$sql_select = "SELECT * FROM add_product WHERE id_additem = $iditem ORDER BY id DESC LIMIT 10";
